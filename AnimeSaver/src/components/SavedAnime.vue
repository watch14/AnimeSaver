                ...
                <div class="anime-details">
                    ...
                    <div class="rating-container">
                        ...
                        <button @click="toggleWatchedStatus(anime.id, anime.watched)"
                            ...
                            {{ anime.watched ? 'Mark as Unwatched' : 'Mark as Watched' }}
                        </button>
                    </div>
                </div>
            </div>
    ...
    methods: {
        async fetchAnimeData() {
            ...
            try {
                ...
                this.totalPages = Math.ceil(userAnimeIds.length / this.limit);

                if (userAnimeIds.length > 0) {
                    const paginatedIds = userAnimeIds.slice(offset, offset + this.limit);
